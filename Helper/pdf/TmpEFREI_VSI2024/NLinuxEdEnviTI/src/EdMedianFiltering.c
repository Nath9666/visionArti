...
#include "EdLibMedianFiltering.h"
...
int main(int argc, char **argv)
{
  ...
  if(argc != 3)
  {
    fprintf(stderr,"USAGE :  MedianFiltering image immoy \n");
...
/* --- Mean Filtering using 3 by 3 neighbourhood --- */
  ret = MedianFiltering (image, imres);
  if (ret)
  {
...
/* --- Free of Images --- */
  ...
  fprintf(stderr,"End of MedianFiltering Operator\n");
}
