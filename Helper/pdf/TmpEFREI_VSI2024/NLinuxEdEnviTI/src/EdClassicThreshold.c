...
#include "EdLibClassicThreshold.h"
...
int main(int argc, char **argv)
{
  ...
  if(argc != 4)
  {
    fprintf(stderr,"USAGE :  EdClassicThreshold image immoy Th \n");
...
/* --- Example of Simple Scan --- */
  ret = ClassicThreshold (image, imres, Th);
  if (ret)
  {
...
/* --- Free of Images --- */
  ...
  fprintf(stderr,"End of ClassicThreshold Operator\n");
}
