...
#include "EdLibRVBGradientThrThi.h"
...
int main(int argc, char **argv)
{
  ...
  if(argc != 5)
  {
    fprintf(stderr,"USAGE :  RVBGradientThrThi image imnorm impts Th\n");
  ...
  ret = RVBGradientThrThi (image, imnorm, imarg, impts, Th); 
  if (ret)
  {
...
/* --- Free of Images --- */
  ...
  fprintf(stderr,"End of Kirsh4 Gradient Operator\n");
  system("PAUSE"); // Windows Only
  return 0;
}
